                        ...
                        <el-col :span="18">
                            ...
                            <div style="height:70px">商品描述</div>
                                <el-row style="height:50px">
                                    ...
                                    <el-col :span="9">上架时间</el-col>
                                    <el-col :span="3"><el-button round size="small">编辑</el-button></el-col>
                                    <el-col :span="3"><el-button size="small" type="danger" round>下架</el-button></el-col>
                                    <el-col :span="5"><el-button size="small" type="success" round>确认出售</el-button></el-col>
                                </el-row>
                        </el-col>
                    </el-row>
                </el-card>
				...
				<el-card class="card_container">
                    <el-row class="goods_post_container">
                        ...
                        <el-col :span="18">
                            ...
                            <div style="height:70px">商品描述</div>
                                <el-row style="height:50px">
                                    <el-col :span="18">上架时间</el-col>
                                    <el-col :span="3"><el-button size="small" round>编辑</el-button></el-col>
